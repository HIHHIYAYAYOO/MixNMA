  ...
  Widget _buildDetails(TextStyle titleStyle, TextStyle detailStyle) {
    return Column(
      ...
      children: [
        ...
        if(showPopular) _buildDetailText("熱度: ${comic.popular}", detailStyle),
        if(showLastUpdate) _buildDetailText("更新時間: ${comic.lastUpdate?.toIso8601String().split('T').first}", detailStyle),
      ],
    );
  }
