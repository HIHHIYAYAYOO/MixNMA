...
class SortedNovel extends StatefulWidget {
  ...
  @override
  State<SortedNovel> createState() => _SortedNovelState();
}


class _SortedNovelState extends State<SortedNovel> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> _fetchNextPage() async {
    ...
    final newNovels = await Wenku8API.getNovelListWithInfo(widget.sortBy, _currentPage);
