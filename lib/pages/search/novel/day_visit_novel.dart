...
class DayVisitNovel extends StatefulWidget {
  const DayVisitNovel({super.key});

  @override
  State<DayVisitNovel> createState() => _DayVisitNovelState();
}


class _DayVisitNovelState extends State<DayVisitNovel> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> _fetchNextPage() async {
    ...
    final newNovels = await Wenku8API.getNovelListWithInfo(NovelSortBy.dayVisit, _currentPage);
